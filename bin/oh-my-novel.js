#!/usr/bin/env node
// bin/oh-my-novel.js
// Wrapper script that detects platform and spawns correct binary
...
function main() {
  ...
  try {
    ...
    console.error(`\noh-my-novel: Platform binary not installed.`);
    console.error(
  ...
  // Handle spawn errors
  if (result.error) {
    console.error(`\noh-my-novel: Failed to execute binary.`);
